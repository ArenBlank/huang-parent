...
const SCHEDULE_ID = 2;
// Single user token — hardcoded after generation
...
export default function () {
  ...
  if (SINGLE_TOKEN) {
    headers['Authorization'] = `Bearer ${SINGLE_TOKEN}`;
  }
...
export function handleSummary(data) {
  ...
  return {
    stdout: `
================================================================
  ROUND 1: Nginx Routing & Redis Distributed Rate Limit
  Single user, 100 VU burst → ${BASE}/app/course/enroll
================================================================
